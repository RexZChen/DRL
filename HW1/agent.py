...
class Agent:
    def __init__(self):
        self.policy_net = PolicyNetwork(obv_dim=28, action_dim=8)
        self.value_net = ValueNetwork(obv_dim=28)

#
# agent = Agent()
# print(list(agent.policy_net.parameters()))
